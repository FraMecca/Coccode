...
namespace espJson_inn { //-------- namespace: espJson_inn --------------//
    ...
    //--- densityDivideVals ---
    const std::vector<double> densityDivideVals_default{ -65.0, -40.0, -15.0, 15.0, 40.0, 65.0 }; //- 较为均匀的分布

    const std::vector<double> densityDivideVals_50_20_50{ -50.0, -30.0, -10.0, 10.0, 30.0, 50.0 }; //- 两极各占:50，中间lvl各占:20
