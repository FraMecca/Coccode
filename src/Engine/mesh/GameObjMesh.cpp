...
void GameObjMesh::RenderUpdate_auto()
{
    ...
    if (this->animActionPtr->get_isOpaque()) {
        esrc::get_renderPool(RenderPoolType::Opaque).insert(this->picMeshUPtr->get_render_z(), this->picMeshUPtr->getnc_ChildMeshPtr());
    } else {
        esrc::get_renderPool(RenderPoolType::Translucent).insert(this->picMeshUPtr->get_render_z(), this->picMeshUPtr->getnc_ChildMeshPtr());
    }
    ...
    if (this->isHaveShadow) {
        ...
        //---
        esrc::get_renderPool(RenderPoolType::Shadow).insert(this->shadowMeshUPtr->get_render_z(), this->shadowMeshUPtr->getnc_ChildMeshPtr());
    }
}
