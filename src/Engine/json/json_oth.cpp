    ...
    JsonValType jsonValType_)
{
    ...
    switch (jsonValType_) {
    case JsonValType::Object:
        tprAssert(a.IsObject());
        break;
    case JsonValType::Array:
        tprAssert(a.IsArray());
        break;
    case JsonValType::Bool:
        tprAssert(a.IsBool());
        break;
    case JsonValType::String:
        tprAssert(a.IsString());
        break;
    case JsonValType::Number:
        tprAssert(a.IsNumber());
        break;
    case JsonValType::Int:
        tprAssert(a.IsInt());
        break;
    case JsonValType::Int64:
        tprAssert(a.IsInt64());
        break;
    case JsonValType::Uint:
        tprAssert(a.IsUint());
        break;
    case JsonValType::Uint64:
        tprAssert(a.IsUint64());
        break;
    case JsonValType::Float:
        tprAssert(a.IsFloat());
        break;
    case JsonValType::Double:
        tprAssert(a.IsDouble());
        break;
    default:
        tprAssert(0);
    }
