...
void chunkMemState_debug(chunkKey_t key_, const std::string& str_)
{
    ...
    case ChunkMemState::NotExist:
        tprDebug::console("{}: NotExist", str_);
        break;
    case ChunkMemState::WaitForCreate:
        tprDebug::console("{}: NotExist", str_);
        break;
    case ChunkMemState::OnCreating:
        tprDebug::console("{}: OnCreating", str_);
        break;
    case ChunkMemState::Active:
        tprDebug::console("{}: Active", str_);
        break;
    case ChunkMemState::WaitForRelease:
        tprDebug::console("{}: WaitForRelease", str_);
        break;
    case ChunkMemState::OnReleasing:
        tprDebug::console("{}: OnReleasing", str_);
        break;
    default:
        tprAssert(0);
        break;
