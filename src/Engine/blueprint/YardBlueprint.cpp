...
void YardBlueprint::init_check() noexcept
{
    ...
    if (this->isHaveMajorGos) {
        tprAssert(!this->majorGo_mapDataIds.empty() && !this->majorGo_mapDatas.empty() && !this->majorGo_varTypes.empty() && !this->majorGo_varTypeDatas.empty());
        //-- shuffle --//
        std::shuffle(this->majorGo_mapDataIds.begin(), this->majorGo_mapDataIds.end(), shuffleEngine);
    }
    if (this->isHaveFloorGos) {
        tprAssert(!this->floorGo_mapDataIds.empty() && !this->floorGo_mapDatas.empty() && !this->floorGo_varTypes.empty() && !this->floorGo_varTypeDatas.empty());
        //-- shuffle --//
