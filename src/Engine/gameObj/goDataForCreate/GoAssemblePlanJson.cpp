            ...
            */
            ...
            for (auto& goMesh : goMeshs.GetArray()) { // each goMesh ent
                ...
                if (goMesh.HasMember("renderLayerType")) {
                    ...
                    (isHave_plan_renderLayerType) ? json_GoMeshEnt.renderLayerType = plan_renderLayerType : json_GoMeshEnt.renderLayerType = go_renderLayerType;
                }
                ...
                if (goMesh.HasMember("shaderType")) {
                    ...
                    (isHave_plan_shaderType) ? json_GoMeshEnt.shaderType = plan_shaderType : json_GoMeshEnt.shaderType = go_shaderType;
                }
