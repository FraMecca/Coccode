    ...
    IntVec2 dogoMPos_)
{
    ...
    if ((off.x > -colliOth_inn::boundary_from_Separate_2_Adjacent) && (off.x < colliOth_inn::boundary_from_Separate_2_Adjacent) && (off.y > -colliOth_inn::boundary_from_Separate_2_Adjacent) && (off.y < colliOth_inn::boundary_from_Separate_2_Adjacent)) {
    ...
    for (int j = -1; j <= 1; j++) {
        for (int i = -1; i <= 1; i++) { // nearby 8 mapents
            ...
            if ((is_closeEnough(absOff.x, sum_of_2_radius, 0.8) && (absOff.y < sum_of_2_radius)) || (is_closeEnough(absOff.y, sum_of_2_radius, 0.8) && (absOff.x < sum_of_2_radius))) {
    ...
    const std::set<NineDirection>& AdjacentMapEnts_) noexcept
{
    ...
    if (AdjacentMapEnts_.size() == 1) {
        ...
        case NineDirection::LeftTop:
            ...
            return (tv.y >= 0.0) ? nineDirection_2_dVec2(NineDirection::Right) : // anti
        ...
        case NineDirection::RightTop:
            ...
            return (tv.y >= 0.0) ? nineDirection_2_dVec2(NineDirection::Bottom) : // anti
        ...
        case NineDirection::RightBottom:
            ...
            return (tv.y >= 0.0) ? nineDirection_2_dVec2(NineDirection::Left) : // anti
        ...
        case NineDirection::LeftBottom:
            ...
            return (tv.y >= 0.0) ? nineDirection_2_dVec2(NineDirection::Top) : // anti
