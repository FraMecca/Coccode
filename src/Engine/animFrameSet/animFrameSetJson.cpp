 ...
 */
        ...
        bool isPjtSingle_)
    {
        ...
        for (size_t i = 0; i < idxNums; i++) {
            isPjtSingle_ ? jFrameIdx = 0 : jFrameIdx = i;
 ...
 */
        ...
        bool isPjtSingle_)
    {
        ...
        isPjtSingle_ ? jFrameIdx = 0 : jFrameIdx = lFrameIdx;
 ...
 */
    ...
    NineDirection jsonStr_2_ninedirection(const std::string& str_)
    {
        ...
        if (str_ == "Center") {
            ...
            return NineDirection::Left;
        } else if (str_ == "LT") {
            return NineDirection::LeftTop;
        } else if (str_ == "T") {
            return NineDirection::Top;
        } else if (str_ == "RT") {
            return NineDirection::RightTop;
        } else if (str_ == "R") {
            return NineDirection::Right;
        } else if (str_ == "RB") {
            return NineDirection::RightBottom;
        } else if (str_ == "B") {
            return NineDirection::Bottom;
        } else if (str_ == "LB") {
            return NineDirection::LeftBottom;
        } else {
            tprAssert(0);
