    ...
    bool isHaveShadow_)
{
    ...
    (param_.isOrder) ? this->frameIdxs.insert(this->frameIdxs.end(), param_.lFrameIdxs.begin(), param_.lFrameIdxs.end()) : this->frameIdxs.insert(this->frameIdxs.end(), param_.lFrameIdxs.rbegin(), param_.lFrameIdxs.rend());
    ...
    if (param_.isTimeStepsManualSet) {
        ...
        (param_.isOrder) ? this->timeSteps.insert(this->timeSteps.end(), param_.timeSteps.begin(), param_.timeSteps.end()) : this->timeSteps.insert(this->timeSteps.end(), param_.timeSteps.rbegin(), param_.timeSteps.rend());
    } else {
